  ...
  return (
    <Layout hideTopBar hideBottomNav>
      <div className="mx-4 mt-4 rounded-3xl bg-white p-6 shadow-soft">
        ...
        <p className="mt-1 text-sm text-neutral-600">Your Details Are Safe With Us, Only Your First Name Will Be Shared With Drivers.</p>
        <div className="mt-6 space-y-3">
          ...
          <Button className="h-12 w-full rounded-full" onClick={()=>{ const updates = { firstName: first, lastName: last, gender, location }; setOnboarding(updates); mergeOnboardingToDriver(updates); nav("/user/register/documents"); }}>Next</Button>
